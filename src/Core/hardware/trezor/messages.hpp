...
enum MessageType {
	...
	MessageType_BitcutyEmptyResponse                     = 800,
	MessageType_BitcutyStartRequest                      = 801,
	MessageType_BitcutyStartResponse                     = 802,
	MessageType_BitcutyScanOutputsRequest                = 803,
	MessageType_BitcutyScanOutputsResponse               = 804,
	MessageType_BitcutyGenerateKeyimageRequest           = 805,
	MessageType_BitcutyGenerateKeyimageResponse          = 806,
	MessageType_BitcutyGenerateOutputSeedRequest         = 807,
	MessageType_BitcutyGenerateOutputSeedResponse        = 808,
	MessageType_BitcutyExportViewWalletRequest           = 809,
	MessageType_BitcutyExportViewWalletResponse          = 810,
	MessageType_BitcutySignStartRequest                  = 811,
	MessageType_BitcutySignAddInputRequest               = 813,
	MessageType_BitcutySignAddOutputRequest              = 815,
	MessageType_BitcutySignAddOutputResponse             = 816,
	MessageType_BitcutySignAddExtraRequest               = 817,
	MessageType_BitcutySignStepARequest                  = 819,
	MessageType_BitcutySignStepAResponse                 = 820,
	MessageType_BitcutySignStepAMoreDataRequest          = 821,
	MessageType_BitcutySignGetC0Request                  = 823,
	MessageType_BitcutySignGetC0Response                 = 824,
	MessageType_BitcutySignStepBRequest                  = 825,
	MessageType_BitcutySignStepBResponse                 = 826,
	MessageType_BitcutyStartProofRequest                 = 827
};
